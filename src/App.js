...
export default class App extends Component {
  ...
  submitHandler = e => {
    ...
    axios.post('https://sheet.best/api/sheets/fe3f3e4a-4e5a-4fd8-98d5-3c8b23fbb5c7', this.state)
    .then(response => {
  ...
  getData = e => {
    ...
    axios.get('https://sheet.best/api/sheets/fe3f3e4a-4e5a-4fd8-98d5-3c8b23fbb5c7')
    .then(response => {
      console.log(response);
    })
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <Container>
          <Button color="blue" onClick={this.getData} type='button'>Console dos Dados na Planilha</Button>
        </Container>
      </>
    )
  }
